"""
Django settings for snakefly project.
...
SECRET_KEY = '%p59^iqa#h(6kx9%2=-buhgqcz13)#in=-w__!m%2m+%l!+bsq'
...
WSGI_APPLICATION = 'snakefly.wsgi.application'
